                ...
                <div class="col-lg-6">
                    <div class="xzoom-container">
                        <div class="product-img">
                            <img class="xzoom" id="xzoom-default" src="{{ asset('site-assets/images/1.jpg') }}" xoriginal="{{ asset('site-assets/images/1.jpg') }}" />
                        </div>
                        <div class="xzoom-thumbs">
                            <a href="{{ asset('site-assets/images/1.jpg') }}"><img class="xzoom-gallery" src="{{ asset('site-assets/images/1.jpg') }}"  xpreview="{{ asset('site-assets/images/1.jpg') }}"> </a>
                            <a href="{{ asset('site-assets/images/2.jpg') }}"><img class="xzoom-gallery" src="{{ asset('site-assets/images/2.jpg') }}"> </a>
                            <a href="{{ asset('site-assets/images/3.jpg') }}"><img class="xzoom-gallery" src="{{ asset('site-assets/images/3.jpg') }}"> </a>
                            <a href="{{ asset('site-assets/images/4.jpg') }}"><img class="xzoom-gallery" src="{{ asset('site-assets/images/4.jpg') }}"> </a>
                        </div>
                    </div>        
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="product-dtl-body">
                            ...
                            <div class="row mt-4">
                                <div class="offset-lg-3 col-lg-6">
                                    <a href="cart.php" class="btn btn-one d-block mb-3" data-bs-toggle="modal" data-bs-target="#checkout">Add to cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="product-dtl-tabs pa-t">
        <div class="container">
            <div class="product-tab-header">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-other-product-tab" data-bs-toggle="pill" data-bs-target="#pills-other-product" type="button" role="tab" aria-controls="pills-other-product" aria-selected="true">Taste Good With</button>
                    </li>
                    <li class="nav-item" role="presentation">
          ...
          <div class="tab-content my-3" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-other-product" role="tabpanel" aria-labelledby="pills-other-product-tab">
