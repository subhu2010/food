...
<div id="surprise-home-content">
            ...
            <div id="homeBanner" class="carousel slide carousel-fade home-show-carousel" data-bs-ride="carousel">
                ...
                <div class="carousel-inner h-100">
                    <div class="carousel-item active home-banner-img">
                        <img src="{{ asset('site-assets/images/carousel/5.jpg') }}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>welcome to foodonways</h3>
                        </div>
                    </div>
                    <div class="carousel-item home-banner-img">
                        <img src="{{ asset('site-assets/images/carousel/4.jpg') }}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>welcome to foodonways</h3>
                        </div>
                    </div>
    ...
    <!-- menu section -->
        <div class="menu-section align-items-center pa-tb my-2 d-flex">
            <div class="container">
                <div class="row">
                    <div class="col-6">
                        <div class="section-title">
