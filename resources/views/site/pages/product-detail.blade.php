...
@section("page_title", $data["product"]->name)
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('site.landingPage') }}">Home</a>
                </li>
                <li class="breadcrumb-item">
                ...
                <div class="product-summary">
                    ...
                    <!-- <div class="product-addon">
                        ...
                        <p class="checkbox">
                            ...
                            <label class="show-total" for="1" class="fw-700"> 
                                NO ONION (–Rs 50)
                            </label><br>
                        </p>
                        <p class="checkbox">
                            <input type="checkbox" class="show-total" id="2" name="2" value="">
                            <label class="show-total" for="2" class="fw-700">
                                NO MUSTARD (–Rs 40)
                            </label><br>
                        </p>
                        <p class="checkbox">
                            <input type="checkbox" class="show-total" id="3" name="3" value="">
                            <label class="show-total" for="3" class="fw-700"> 
                                NO CHEESE (-Rs 100)
                            </label><br>
                        </p>
                        <p class="checkbox">
                            <input type="checkbox" class="show-total" id="4" name="4" value="">
                            <label class="show-total" for="4" class="fw-700"> 
                                NO JALAPENO (–Rs 40)
                            </label><br>
                        </p>
                    </div> -->
