                            ...
                            <div class="col-lg-5">
                                <div class="user-avatar-section bs-space d-flex">
                                    <div class="user-avatar me-2 text-center">
                                        <img src="{{asset('site-assets/images/avatar/3.jpg')}}" class="img-fluid" alt="food on ways">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="bs-space">
                                        <div class="video-content" style="padding: 0;background: none;height: 265px;">
                                            <video controls autoplay> <source src="{{asset('site-assets/images/1.mp4')}}" type="video/mp4"> </video>
                                        </div>
                                    </div>
                                </div>
                            </div>
