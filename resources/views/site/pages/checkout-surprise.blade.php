        ...
        <div class="checkout-process">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="checkout-delivery-card mb-5">
                        <h5 class="delivery-card-head fw-800">Delivery Type</h5>
                        <div class="delivery-card-body flex-center justify-content-between">
                            <label class="custom-checkbox mb-0">Surprise Food
                                <input type="checkbox" checked="checked">
                                <span class="checkmark"></span>
                            </label>
                            <label class="custom-checkbox mb-0">Customized Food
                                <input type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                            <label class="custom-checkbox mb-0">Regular Food
                                <input type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    ...
                    <div class="checkout-delivery-card">
                        <h5 class="delivery-card-head fw-800">Delivery Time</h5>
                        <div class="delivery-card-body delivery-time d-flex">
                            <div class="form-check p-0">
                                <input class="form-check-input d-none" type="radio" name="flexRadioDefault" id="radio1">
                                <label class="form-check-label" for="radio1">
                                    Today
                                </label>
                            </div>
                            <div class="form-check p-0">
                                <input class="form-check-input d-none" type="radio" name="flexRadioDefault" id="radio2">
                                <label class="form-check-label" for="radio2">
                                    Tomorrow
                                </label>
                            </div>
                            <div class="form-check p-0">
                                <input class="form-check-input d-none" type="radio" name="flexRadioDefault" id="radio3">
                                <label class="form-check-label me-0" for="radio3">
                                    Preorder
                                </label>
                            </div>
                        </div>
                        <div class="delivery-card-body d-flex justify-content-between mt-3">
                            <input class="form-control me-3" type="date"></input>
                            <input class="form-control" type="time"></input>
                        </div>
                    </div>
                    <div class="checkout-delivery-card">
                        <h5 class="delivery-card-head fw-800">Message</h5>
                        <div class="delivery-card-body">
